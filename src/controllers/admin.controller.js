...
const pick = (source, keys) =>
  keys.reduce((result, key) => {
    result[key] = source?.[key] ?? (Array.isArray(defaultSiteSetting[key]) ? [] : '');
    return result;
  }, {});
...
export const getDashboardStats = catchAsync(async (_req, res) => {
  const [projects, skills, experiences, education, messages, blogs, recentProjects, recentBlogs, recentMessages] =
    await Promise.all([
...
export const getHomeContent = catchAsync(async (_req, res) => {
  ...
  res.status(StatusCodes.OK).json({
    success: true,
    data: pick(siteSetting, ['fullName', 'jobTitle', 'homeDescription', 'heroTitle', 'heroSubtitle'])
  });
});
...
export const updateHomeContent = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({
    success: true,
    data: pick(updated, ['fullName', 'jobTitle', 'homeDescription', 'heroTitle', 'heroSubtitle'])
  });
});
...
export const deleteService = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ success: true, message: 'Service deleted successfully' });
});
...
export const deleteReview = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ success: true, message: 'Review deleted successfully' });
});
...
export const updateSkill = catchAsync(async (req, res) => {
  ...
  const skill = await prisma.skill.update({ where: { id: req.params.id }, data: req.validated.body });
...
export const deleteSkill = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ success: true, message: 'Skill deleted successfully' });
});

export const createExperience = catchAsync(async (req, res) => {
  const experience = await prisma.experience.create({ data: req.validated.body });
...
export const deleteEducation = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ success: true, message: 'Education deleted successfully' });
});
...
export const deleteBlog = catchAsync(async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ success: true, message: 'Blog deleted successfully' });
});
