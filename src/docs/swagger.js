...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "Backend API for developer portfolio website and admin panel",
    },
    servers: [{ url: "http://localhost:5000" }],
    tags: [
      { name: "Auth", description: "Authentication endpoints" },
      { name: "Portfolio", description: "Public portfolio content endpoints" },
      { name: "Messages", description: "Public contact message endpoints" },
      { name: "Admin", description: "Authenticated admin management endpoints" },
    ],
    components: {
      securitySchemes: {
        bearerAuth: {
      ...
      schemas: {
        ...
        SystemSetting: {
          ...
          properties: {
            ...
            adminNotificationEmail: { type: "string" },
          },
        },
        User: {
          type: "object",
